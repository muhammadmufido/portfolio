...
const About = () => {
  ...
  return (
    <section className="section sm:justify-end" id="about" ref={ref}>
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-5 lg:flex-row lg:items-center lg:gap-y-0 lg:gap-x-10 min-h-screen ">
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <h2 className="h2 text-blue-700 font-bold text-center">About me.</h2>
            ...
            <div className="flex gap-x-6 lg:gap-x-10 mb-12">
              <div>
                <div className="text-[40px] font-tertiary text-blue-900">
            ...
            <div className="flex gap-x-8 items-center">
              ...
              <Link to='work' activeClass='active' smooth={true} spy={true} className="cursor-pointer text-blue-900 font-semibold btn-link
                                          ">
                My Portfolio
              </Link>
            </div>
